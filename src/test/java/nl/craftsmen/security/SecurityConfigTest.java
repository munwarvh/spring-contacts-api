...
class SecurityConfigTest {
	...
	@Mock
	private ServerHttpSecurity.ExceptionHandlingSpec exceptionHandlingSpec;
	...
	private void mockServerHttpSecurity() {
		// Exception handling
		given(serverHttpSecurity.exceptionHandling()).willReturn(exceptionHandlingSpec);
		given(exceptionHandlingSpec.authenticationEntryPoint(any())).willReturn(exceptionHandlingSpec);
		given(exceptionHandlingSpec.and()).willReturn(serverHttpSecurity);
		...
		given(frameOptionsSpec.disable()).willReturn(headerSpec);
		given(headerSpec.and()).willReturn(serverHttpSecurity);
