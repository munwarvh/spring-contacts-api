...
public class GlobalExceptionHandler {
    ...
    private static final String CONSTRAINT_VIOLATION_ERROR_MESSAGE =
            "ConstraintViolationException occurred while processing";
    ...
    public ResponseEntity<ApiError> handelException(ResourceNotFoundException exception) {
        log.error(exception.getMessage(), exception);
        return new ResponseEntity<>(getResourceNotFoundExceptionApiError(exception), HttpStatus.NOT_FOUND);
    }
    ...
    private ApiError getResourceNotFoundExceptionApiError(ResourceNotFoundException exception) {
        return ApiError.builder()
                .errorMessage(exception.getMessage())
                .build();
    }
